...
public class CircleProgressBar extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        paint.setColor(Color.rgb(0xEC, 0xEC, 0xEC)); // 设置画笔颜色
        ...
        paint.setColor(Color.rgb(0x3F, 0xAA, 0xFF));
    ...
    public void showProgress(final int progress, final CircleProgressBar progressBar){
        new Thread()
        {
            public void run()
            {
