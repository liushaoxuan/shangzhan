...
public class CardAdapter extends BaseAdapter {
    ...
    private ArrayList<CardNewModule.Card> list;
    private UserInfo mUser;
    private int type;

    public CardAdapter(Context context, ArrayList<CardNewModule.Card> list, int type){
    ...
    @Override
    public CardNewModule.Card getItem(int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Glide.with(context).load(getItem(position).getCard_img()).dontAnimate().placeholder(R.mipmap.def_card).into(holder.card);
