...
public class ChildTaskArrangeAdapter extends android.widget.BaseAdapter {
    private static final String TAG="ScheduleAdapter";
    private ViewHolder vh;
    private Context context;
    private List<ChildTaskModel>list=new ArrayList<>();

    public ChildTaskArrangeAdapter(Context context) {
        this.context = context;
    }

    public ChildTaskArrangeAdapter(Context context, List<ChildTaskModel> list) {
        this.context = context;
        this.list = list;
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        vh.tv_userName.setText(list.get(i).getHeader_name());
