...
public class oaReimbuesementDetailAdapter extends RecyclerView.Adapter<oaReimbuesementDetailAdapter.ViewHolder> {

    private Context context;
    private List<oaPaymentModel> list;

    public oaReimbuesementDetailAdapter(Context context, List<oaPaymentModel> list) {
