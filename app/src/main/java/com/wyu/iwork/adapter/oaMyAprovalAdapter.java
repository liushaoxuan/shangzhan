...
public class oaMyAprovalAdapter extends RecyclerView.Adapter<oaMyAprovalAdapter.ViewHolder>{

    private Context context;
    private List<oaAprovalSendLauchModel> list;
    private  onItemClickListener onItemClickListener;

    public oaMyAprovalAdapter(Context context, List<oaAprovalSendLauchModel> list) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ...
        private void setDate(final int position){
            ...
            duration.setText(item.getNumber()+"小时");
