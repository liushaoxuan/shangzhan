...
public class TaskAssistantAdapter extends RecyclerView.Adapter<TaskAssistantAdapter.ViewHolder>{
    ...
    private float mRawX;
    private float mRawY;
    public TaskAssistantAdapter(Context context,List<TaskAssistentModel> list) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnTouchListener {
        ...
        private void setdata(final int position){
            ...
            final TaskAssistentModel item = list.get(position);
