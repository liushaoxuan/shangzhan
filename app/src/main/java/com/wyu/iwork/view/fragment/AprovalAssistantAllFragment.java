...
public class AprovalAssistantAllFragment extends Fragment implements BGARefreshLayout.BGARefreshLayoutDelegate ,DeleteListener{

    private static String TAG = AprovalAssistantAllFragment.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        activity.getData(index,"0",callback());
        return view;
    }
