...
public class TaskFinishedFragment extends BaseFragment {

    private static final String TAG = TaskFinishedFragment.class.getSimpleName();
    ...
    private void getFinishTask(){
        ...
        String Sign = Md5Util.getSign(F+V+RandStr+info.getUser_id()+info.getCompany_id()+"3");
