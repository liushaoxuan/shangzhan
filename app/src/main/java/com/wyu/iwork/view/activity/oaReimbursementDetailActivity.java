...
import com.wyu.iwork.adapter.oaReimbuesementDetailAdapter;
...
public class oaReimbursementDetailActivity extends BaseActivity {

    private static String TAG = oaReimbursementDetailActivity.class.getSimpleName();
     ...
     * 头像
     */
    @BindView(R.id.activity_oa_reimbursement_details_head)
    ImageView mHead;

    /**
     * 发起人
     */
    @BindView(R.id.activity_oa_reimbursement_details_my_apply)
    TextView my_apply;

    /**
     * 审批状态
     */
    @BindView(R.id.activity_oa_reimbursement_details_state)
    TextView status;

    /**
     * 报销费用类型
     */
    @BindView(R.id.activity_oa_reimbursement_details_pay_type)
    TextView coast_type;

    /**
     * 报销费用金额
     */
    @BindView(R.id.activity_oa_reimbursement_details_money)
    TextView coast_total;

    /**
     * 明细的recyclerview
     */
    @BindView(R.id.activity_oa_reimbursement_details_reibursent_recyclerview)
    RecyclerView detailRecyclerview;

    /**
     * 审批流程的recyclerview
     */
    @BindView(R.id.activity_oa_reimbursement_details_state_recyclerview)
     ...
     *
     */
    @BindView(R.id.activity_oa_reimbursement_details_scrollview)
    NestedScrollView detailview;

    /**
     * 收起 展开 layout
     */
    @BindView(R.id.activity_oa_reimbursement_details_open_close_layout)
    LinearLayout close_open_layout;
    /**
     * 收起 展开
     */
    @BindView(R.id.activity_oa_reimbursement_details_open_close)
    TextView close_open;
    /**
     * 报销 事由
     */
    @BindView(R.id.activity_oa_reimbursement_details_reason)
    TextView reson;


    @BindView(R.id.activity_oa_reimbursement_details_open_close_detail)
    TextView close_open_detail;
    /**
     * 抄送人recyclerview
     */
    @BindView(R.id.activity_oa_reimbursement_details_copysend_recyclerview)
    RecyclerView copysendRecyclerview;
    /**
     * 报销详情的layout
     */
    @BindView(R.id.activity_oa_reimbursement_details_layout)
    LinearLayout detail_layout;

    /**
     * 职位
     */
    @BindView(R.id.activity_oa_reimbursement_details_post)
     ...
     * 明细adapter
     */
    private oaReimbuesementDetailAdapter detailAdapter;
    /**
     * 抄送人adapter
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_oa_reimbursement_details);
    ...
    @OnClick({R.id.oa_back, R.id.activity_oa_apply_leave_detail_cuiban, R.id.activity_oa_apply_leave_detail_getback, R.id.activity_oa_apply_leave_detail_agree,
            R.id.activity_oa_apply_leave_detail_to_others, R.id.activity_oa_apply_leave_detail_to_back,R.id.activity_oa_reimbursement_details_open_close_layout})
    void Click(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.activity_oa_apply_leave_detail_to_back://驳回
                ...
                startActivity(intent);
                break;
            case R.id.activity_oa_reimbursement_details_open_close_layout://展开 收起
            ...
            public void onSuccess(String s, Call call, Response response) {
                try {
                    ...
                    if ("0".equals(code)) {
                        ...
                        Toast.makeText(oaReimbursementDetailActivity.this, object.optString("msg"), Toast.LENGTH_SHORT).show();
                    }
                } catch (Exception e) {
                    e.printStackTrace();
    ...
    private void setData4Views() {
        ...
        detailAdapter = new oaReimbuesementDetailAdapter(this, detailModel.getPayment());
        detailRecyclerview.setAdapter(detailAdapter);

        status.setText(statu);
        my_apply.setText(detailModel.getUser_name()+"的报销申请");
        post_position.setText(detailModel.getUser_job());
        coast_type.setText(detailModel.getApply_type());
        coast_total.setText(detailModel.getNumber() + "元");
