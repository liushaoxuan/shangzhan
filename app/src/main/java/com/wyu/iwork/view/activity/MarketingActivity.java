...
import com.wyu.iwork.adapter.MarketingAdapter;
 ...
 * CRM - 市场活动
 */
public class MarketingActivity extends BaseActivity implements BGARefreshLayout.BGARefreshLayoutDelegate{
    ...
    private void initView(){
        ...
        initRefreshLayout();
        zanwu_textone.setText("您还没有活动，请在右上方“");
        zanwu_textthree.setText("”添加活动");
    }
    ...
    private void setAdapter(){
        if(adapter == null){
            adapter = new MarketingAdapter(this,marketList);
