...
import com.wyu.iwork.adapter.oaSendToMeAdapter;
...
public class oaCopySendToMeActivity extends BaseActivity implements BGARefreshLayout.BGARefreshLayoutDelegate,onItemClickListener {
    ...
    //初始化
    private void init(){
        title.setText(R.string.send_to_me);
    ...
    private void initParama(){
        url = Constant.URL_OA_COPY_SEND_TO_ME;
            ...
            public void onSuccess(String s, Call call, Response response) {
                try {
                    ...
                    if ("0".equals(code)) {
                        ...
                        Toast.makeText(oaCopySendToMeActivity.this, object.optString("msg"), Toast.LENGTH_SHORT).show();
                    }
    ...
    public boolean onBGARefreshLayoutBeginLoadingMore(BGARefreshLayout refreshLayout) {
        if (hasmore){
            ...
            Toast.makeText(oaCopySendToMeActivity.this, "已加载完毕", Toast.LENGTH_SHORT).show();
            return false;
        }
    }
    ...
    public void onItemClick(View view, int position) {
        ...
        switch (type){
            case "1"://请假
                intent = new Intent(oaCopySendToMeActivity.this,oaApplyForLeaveDetailActivity.class);
            ...
            case "2"://加班
                intent = new Intent(oaCopySendToMeActivity.this,oaWorkOverTimeDetailActivity.class);
                intent.putExtra("id",id);
                ...
                break;
            case "3"://出差
                intent = new Intent(oaCopySendToMeActivity.this,oaBusinessTravelDetailActivity.class);
                intent.putExtra("id",id);
            ...
            case "4"://报销
                intent = new Intent(oaCopySendToMeActivity.this,oaReimbursementDetailActivity.class);
                intent.putExtra("id",id);
                intent.putExtra("flag",-1);
                startActivity(intent);
                break;
