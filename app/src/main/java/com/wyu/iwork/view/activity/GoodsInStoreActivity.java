 ...
 * 商品入库
 */
public class GoodsInStoreActivity extends BaseActivity implements BGARefreshLayout.BGARefreshLayoutDelegate{
    ...
    private GoodsInStoreAdapter adapter;
    ...
    //入库商品集合
    private List<InStoreModel> list = new ArrayList<>();
    @Nullable
    @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText("商品入库");
        nodata_text.setText("暂无商品入库");
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        adapter = new GoodsInStoreAdapter(this,list);
    ...
    void Click(View v){
        switch (v.getId()){
            ...
            case R.id.action_add://添加
                Intent intent = new Intent(this,BuildGoodsInstoreActivity.class);
            ...
            public void onSuccess(String s, Call call, Response response) {
                try {
                    ...
                    if ("0".equals(code)) {
                        ...
                        List<InStoreModel> templist = JSON.parseArray(data.toString(),InStoreModel.class);
                        ...
                        Toast.makeText(GoodsInStoreActivity.this,object.optString("msg"),Toast.LENGTH_SHORT).show();
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
