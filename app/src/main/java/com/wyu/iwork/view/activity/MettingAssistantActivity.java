...
import com.wyu.iwork.adapter.MettingAssistantAdapter;
import com.wyu.iwork.adapter.NoticeAssistantAdapter;
 ...
 * 会议通知
 */
public class MettingAssistantActivity extends BaseActivity implements BGARefreshLayout.BGARefreshLayoutDelegate,DeleteListener {

    private static String TAG = MettingAssistantActivity.class.getSimpleName();
    ...
    private MettingAssistantAdapter adapter;
    ...
    private void init() {
        ...
        adapter = new MettingAssistantAdapter(this, list);
    ...
    private void initparama() {
        url = Constant.URL_METTING_ASSISTENT;
        String user_id = null;
        ...
        return new DialogCallback(this) {
            ...
            public void onSuccess(String s, Call call, Response response) {
                ...
                try {
                    ...
                    if ("0".equals(code)) {
                        List<MettingAssistenModel> templist = new ArrayList<>();
                        templist = JSON.parseArray(data.toString(), MettingAssistenModel.class);
                        list.addAll(templist);
                        adapter.notifyDataSetChanged();
                        templist.clear();
                        templist = null;
                    } else {
                        Toast.makeText(MettingAssistantActivity.this, msg, Toast.LENGTH_SHORT).show();
                    }
                    if (list==null||list.size()==0){
                        nodata_layout.setVisibility(View.VISIBLE);
                        del_layout.setVisibility(View.GONE);
                        nodata_text.setText(R.string.no_metting_notification);
...
//类别 1：任务 2：公告 3：会议 4：审批
        AssisttentDelUtil.message_delete(this, "3", list.get(position).getMessage_id(), delCallback(position));
    }
