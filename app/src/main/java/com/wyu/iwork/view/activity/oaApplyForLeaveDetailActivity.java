 ...
 * oa 请假详情
 */
public class oaApplyForLeaveDetailActivity extends BaseActivity {
     ...
     * 头像
     */
    @BindView(R.id.activity_oa_apply_for_leave_detail_head)
    ImageView mHead;

    /**
     * 发起人
     */
    @BindView(R.id.activity_oa_apply_for_leave_detail_my_apply)
    TextView my_apply;

    /**
     * 审批状态
     */
    @BindView(R.id.activity_oa_apply_for_leave_detail_state)
    TextView status;

    /**
     * 请假类型
     */
    @BindView(R.id.activity_oa_apply_for_leave_detail_pay_type)
    TextView coast_type;

    /**
     * 请假天数
     */
    @BindView(R.id.activity_oa_apply_for_leave_detail_money)
    TextView coast_total;

    /**
     * 明细的recyclerview
     */
    @BindView(R.id.activity_oa_apply_for_leave_detail_reibursent_recyclerview)
    RecyclerView detailRecyclerview;

    /**
     * 审批流程的recyclerview
     */
    @BindView(R.id.activity_oa_apply_for_leave_detail_state_recyclerview)
     ...
     *
     */
    @BindView(R.id.activity_oa_apply_for_leave_detail_scrollview)
    NestedScrollView detailview;

    /**
     * 收起 展开 layout
     */
    @BindView(R.id.activity_oa_apply_for_leave_detail_open_close_layout)
    LinearLayout close_open_layout;
    /**
     * 收起 展开
     */
    @BindView(R.id.activity_oa_apply_for_leave_detail_open_close)
    TextView close_open;


    @BindView(R.id.activity_oa_apply_for_leave_detail_open_close_detail)
    TextView close_open_detail;
    /**
     * 抄送人recyclerview
     */
    @BindView(R.id.activity_oa_apply_for_leave_detail_copysend_recyclerview)
    RecyclerView copysendRecyclerview;
    /**
     * 请假详情的layout
     */
    @BindView(R.id.activity_oa_apply_for_leave_detail_layout)
    LinearLayout detail_layout;

    /**
     * 职位
     */
    @BindView(R.id.activity_oa_apply_for_leave_detail_post)
    TextView post_position;

    /**
     * 请假事由
     */
    @BindView(R.id.activity_oa_apply_for_leave_detail_reason)
    TextView reson;
    ...
    @OnClick({R.id.oa_back, R.id.activity_oa_apply_leave_detail_cuiban, R.id.activity_oa_apply_leave_detail_getback, R.id.activity_oa_apply_leave_detail_agree,
            R.id.activity_oa_apply_leave_detail_to_others, R.id.activity_oa_apply_leave_detail_to_back,R.id.activity_oa_apply_for_leave_detail_open_close_layout})
    void Click(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.activity_oa_apply_leave_detail_to_back://驳回
                ...
                startActivity(intent);
                break;
            case R.id.activity_oa_apply_for_leave_detail_open_close_layout://展开 收起
            ...
            public void onSuccess(String s, Call call, Response response) {
                try {
                    ...
                    if ("0".equals(code)) {
                        ...
                        Toast.makeText(oaApplyForLeaveDetailActivity.this, object.optString("msg"), Toast.LENGTH_SHORT).show();
                    }
                } catch (Exception e) {
                    e.printStackTrace();
    ...
    private void setData4Views() {
        ...
        my_apply.setText(detailModel.getUser_name()+"的请假申请");
        ...
        }else {//申请人不是自己 且审批人中有自己，则显示转交同意布局
            for (int i = 0;i<detailModel.getApproval_list().size();i++){
