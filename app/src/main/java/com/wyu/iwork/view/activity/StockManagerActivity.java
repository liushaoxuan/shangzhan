...
import com.wyu.iwork.adapter.StockManagerAdapter;
...
public class StockManagerActivity extends BaseActivity implements BGARefreshLayout.BGARefreshLayoutDelegate{



    @BindView(R.id.activity_stock_manager_refreshview)
    BGARefreshLayout bgaRefreshLayout;

    @BindView(R.id.activity_stock_manager_recyclerview)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText("库存管理");
        nodata_text.setText("暂无库存信息");
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        adapter = new StockManagerAdapter(this,list);
    ...
    void Click(View v){
        switch (v.getId()){
            ...
            case R.id.action_add://添加
                Intent intent = new Intent(this,BuildStockActivity.class);
            ...
            public void onSuccess(String s, Call call, Response response) {
                try {
                    ...
                    if ("0".equals(code)) {
                        ...
                        List<StockModel> templist = JSON.parseArray(data.toString(),StockModel.class);
                        ...
                        Toast.makeText(StockManagerActivity.this,object.optString("msg"),Toast.LENGTH_SHORT).show();
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
