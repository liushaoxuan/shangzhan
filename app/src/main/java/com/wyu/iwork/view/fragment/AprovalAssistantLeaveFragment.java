...
public class AprovalAssistantLeaveFragment extends Fragment implements BGARefreshLayout.BGARefreshLayoutDelegate ,DeleteListener{

    private static String TAG = AprovalAssistantLeaveFragment.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        activity.getData(index,"1",callback());
        return view;
    }
