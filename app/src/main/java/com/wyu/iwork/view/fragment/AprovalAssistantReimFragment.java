...
public class AprovalAssistantReimFragment extends Fragment implements BGARefreshLayout.BGARefreshLayoutDelegate,DeleteListener {

    private static String TAG = AprovalAssistantReimFragment.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        activity.getData(index,"4",callback());
        return view;
    }
