...
public class oaWaiteMeAprovalFragment extends Fragment implements BGARefreshLayout.BGARefreshLayoutDelegate,onItemClickListener {
    ...
    private void initParama(){
        ...
        String approve_type =  "2";//审批类型(1为已审核,2为待审核)
    ...
    private DialogCallback callback(){
        return new DialogCallback(activity) {
            ...
            public void onError(Call call, Response response, Exception e) {
                Logger.e("OA——待审批的异常了",e.getMessage());
