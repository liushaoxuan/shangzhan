...
import com.wyu.iwork.adapter.PurchaseOrderInAdapter;
 ...
 * 采购订单入库列表
 */
public class PurchaseOrderInActivity extends BaseActivity implements BGARefreshLayout.BGARefreshLayoutDelegate{
    ...
    private PurchaseOrderInAdapter adapter;
    public String flag = "";

    private String url = Constant.URL_PURCHASE_IN_LIST;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new PurchaseOrderInAdapter(this,list);
            ...
            public void onSuccess(String s, Call call, Response response) {
                try {
                    ...
                    if ("0".equals(code)) {
                        ...
                        List<PurchaseInModel> templist = JSON.parseArray(data.toString(),PurchaseInModel.class);
                        list.addAll(templist);
                        adapter.notifyDataSetChanged();
                        templist.clear();
                        templist = null;
                    }else {
                        Toast.makeText(PurchaseOrderInActivity.this,object.optString("msg"),Toast.LENGTH_SHORT).show();
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
