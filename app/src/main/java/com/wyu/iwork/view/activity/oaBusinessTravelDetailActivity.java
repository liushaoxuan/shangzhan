 ...
 * OA 出差详情
 */
public class oaBusinessTravelDetailActivity extends BaseActivity {  
    private static String TAG = oaApplyForLeaveDetailActivity.class.getSimpleName();
     ...
     * 头像
     */
    @BindView(R.id.activity_oa_business_travel_detail_head)
    ImageView mHead;

    /**
     * 审批状态
     */
    @BindView(R.id.activity_oa_business_travel_detail_state)
    TextView status;

    /**
     * 出差类型
     */
    @BindView(R.id.activity_oa_business_travel_detail_pay_type)
    TextView coast_type;

    /**
     * 出差天数
     */
    @BindView(R.id.activity_oa_business_travel_detail_money)
    TextView coast_total;

    /**
     * 明细的recyclerview
     */
    @BindView(R.id.activity_oa_business_travel_detail_reibursent_recyclerview)
    RecyclerView detailRecyclerview;

    /**
     * 审批流程的recyclerview
     */
    @BindView(R.id.activity_oa_business_travel_detail_state_recyclerview)
     ...
     *
     */
    @BindView(R.id.activity_oa_business_travel_detail_scrollview)
    NestedScrollView detailview;

    /**
     * 收起 展开 layout
     */
    @BindView(R.id.activity_oa_business_travel_detail_open_close_layout)
    LinearLayout close_open_layout;
    /**
     * 收起 展开
     */
    @BindView(R.id.activity_oa_business_travel_detail_open_close)
    TextView close_open;


    @BindView(R.id.activity_oa_business_travel_detail_open_close_detail)
    TextView close_open_detail;
    /**
     * 抄送人recyclerview
     */
    @BindView(R.id.activity_oa_business_travel_detail_copysend_recyclerview)
    RecyclerView copysendRecyclerview;
    /**
     * 出差详情的layout
     */
    @BindView(R.id.activity_oa_business_travel_detail_layout)
    LinearLayout detail_layout;
    /**
     * 事由
     */
    @BindView(R.id.activity_oa_business_travel_detail_reason)
    TextView reson;

    /**
     * 职位
     */
    @BindView(R.id.activity_oa_business_travel_detail_post)
    TextView post_position;

    /**
     * 发起人
     */
    @BindView(R.id.activity_oa_business_travel_detail_my_apply)
    TextView my_apply;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_oa_business_travel_detail);
    ...
    @OnClick({R.id.oa_back, R.id.activity_oa_apply_leave_detail_cuiban, R.id.activity_oa_apply_leave_detail_getback, R.id.activity_oa_apply_leave_detail_agree,
            R.id.activity_oa_apply_leave_detail_to_others, R.id.activity_oa_apply_leave_detail_to_back,R.id.activity_oa_business_travel_detail_open_close_layout})
    void Click(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.activity_oa_apply_leave_detail_to_back://驳回
                ...
                startActivity(intent);
                break;
            case R.id.activity_oa_business_travel_detail_open_close_layout://展开 收起
            ...
            public void onSuccess(String s, Call call, Response response) {
                try {
                    ...
                    if ("0".equals(code)) {
                        ...
                        Toast.makeText(oaBusinessTravelDetailActivity.this, object.optString("msg"), Toast.LENGTH_SHORT).show();
                    }
                } catch (Exception e) {
                    e.printStackTrace();
    ...
    private void setData4Views() {
        ...
        detaillist.clear();
        detaillist.add(new oaPaymentModel("出差",detailModel.getStart_time(),detailModel.getEnd_time(),detailModel.getContent()));
        detailAdapter = new oaleaveDetailAdapter(this, detaillist);
        detailRecyclerview.setAdapter(detailAdapter);

        status.setText(statu);
        my_apply.setText(detailModel.getUser_name()+"的出差申请");
