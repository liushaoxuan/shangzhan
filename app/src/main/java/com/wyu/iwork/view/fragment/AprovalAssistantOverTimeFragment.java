...
public class AprovalAssistantOverTimeFragment extends Fragment implements BGARefreshLayout.BGARefreshLayoutDelegate ,DeleteListener{

    private static String TAG = AprovalAssistantOverTimeFragment.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        activity.getData(index,"2",callback());
        return view;
    }
