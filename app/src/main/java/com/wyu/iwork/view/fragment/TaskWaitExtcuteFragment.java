...
public class TaskWaitExtcuteFragment extends BaseFragment {

    private static final String TAG = TaskWaitExtcuteFragment.class.getSimpleName();
    ...
    private void getWaitExecuteTask(){
        /**
        ...
        String Sign = Md5Util.getSign(F+V+RandStr+info.getUser_id()+info.getCompany_id()+"2");
