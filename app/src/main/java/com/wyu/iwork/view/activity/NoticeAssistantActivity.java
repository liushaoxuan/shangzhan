 ...
 *         公告助手
 */
public class NoticeAssistantActivity extends BaseActivity implements BGARefreshLayout.BGARefreshLayoutDelegate,DeleteListener{

    private static String TAG = NoticeAssistantActivity.class.getSimpleName();
    ...
    private NoticeAssistantAdapter adapter;
    ...
    private void init() {
        ...
        adapter = new NoticeAssistantAdapter(this, list);
    ...
    private void initparama(){
        url = Constant.URL_NOTICEASSISTANT;
        String user_id = null;
        ...
        return new DialogCallback(this) {
            ...
            public void onSuccess(String s, Call call, Response response) {
                ...
                try {
                    ...
                    if ("0".equals(code)){
                        List<MessageNoticeAssistanBean> templist = new ArrayList<>();
                        templist = JSON.parseArray(data.toString(),MessageNoticeAssistanBean.class);
                        list.addAll(templist);
                        adapter.notifyDataSetChanged();
                        templist.clear();
                        templist = null;
                    }else {
                        Toast.makeText(NoticeAssistantActivity.this,msg,Toast.LENGTH_SHORT).show();
                    }
                    if (list==null||list.size()==0){
                        nodata_layout.setVisibility(View.VISIBLE);
                        del_layout.setVisibility(View.GONE);
                        nodata_text.setText(R.string.no_notice_notification);
...
//类别 1：任务 2：公告 3：会议 4：审批
        AssisttentDelUtil.message_delete(this, "2", list.get(position).getMessage_id(), delCallback(position));
    }
