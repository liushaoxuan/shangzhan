 ...
 * OA——审批意见——同意
 */
public class oaAgreeApllyActivity extends BaseActivity {

    private static String TAG = oaAgreeApllyActivity.class.getSimpleName();
       ...
       return new DialogCallback(this){
           ...
           public void onSuccess(String s, Call call, Response response) {
               try {
                   ...
                   Toast.makeText(oaAgreeApllyActivity.this, object.optString("msg"), Toast.LENGTH_SHORT).show();
                   Logger.e(TAG,s);
               } catch (Exception e) {
                   e.printStackTrace();
               }
