...
public class StoreDetailModel implements Serializable {
    ...
    public StoreDetailModel(String id, String sole_id, String name, String manager, String province, String city, String district, String address, String creater_id, String creater_name, String add_time) {
        this.id = id;
